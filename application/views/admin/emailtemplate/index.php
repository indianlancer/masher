<script>
    ...
    {
        $("#import_data_link").click(function(e){
            var dataString="data=import";
            var block_mess="<?php echo tr("PLEASE_WAIT_DATA_IMPORT_IS_IN_PROGRESS"); ?>";
            var ret=import_data_process("<?php echo tr("TEMPLATE_DATA_IMPORT_WARN"); ?>",dataString,"content",block_mess,'rep_mess',e,this);
            if(ret!=false)
