                    ...
                    <form action="" method="post" class="form-horizontal" id="sub_form" >
                        ...
                        <input type="hidden" name="tooltask" id="tooltask" value="save" />
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" required="" class="span6" id="txtLabel" name="txtLabel" size="80" value="<?php echo set_value("txtLabel");?>" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="txtSubject" class="control-label">Subject</label>
                                <div class="controls">
                                    <textarea id="txtSubject" required="" class="span6" name="txtSubject" rows="5" cols="90" ><?php echo set_value("txtSubject");?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="txtBody" class="control-label">Meta Description</label>
                                <div class="controls">
                                    <textarea id="txtBody" name="txtBody" ><?php echo set_value("txtBody");?></textarea>
