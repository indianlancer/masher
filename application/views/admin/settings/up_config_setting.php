                  ...
                  <div class="box-content">
                    ...
                    <form action="" method="post" id="sub_form" class="form-horizontal" novalidate>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" value="<?php echo $configdata->param;?>" id="txtParam" name="txtParam" required="">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="txtValue">* <?php echo tr('VALUE');?>:</label>
                            <div class="controls">
                                <input type="text" value="<?php echo $configdata->value;?>" id="txtValue" name="txtValue" required="">
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea cols="40" rows="10" class="input-xlarge" id="txtDesc" name="txtDesc"><?php echo $configdata->description;?></textarea>
                            </div>
                        </div>
                    </form>
                </div>
