                ...
                <div class="box-content">
                    <form enctype="multipart/form-data" action="" method="post" class="form-horizontal" id="sub_form" >
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea id="txtMTitle" <?php rt_validation("required","required").rt_validation("maxlength","200");?> class="span10" name="txtMTitle" rows="5" cols="90" ><?php echo set_value("txtMTitle");?></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="txtMDesc" class="control-label">Short Description</label>
                            <div class="controls">
                                <textarea <?php rt_validation("required","required").rt_validation("maxlength","300");?> id="txtMDesc" class="span10" name="txtMDesc" rows="5" cols="90" ><?php echo set_value("txtMDesc");?></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea id="txtTags" <?php rt_validation("required","required").rt_validation("maxlength","200");?> class="span10" placeholder="Tags must be enter seprated" name="txtTags" rows="5" cols="90" ><?php echo set_value("txtTags");?></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="txtPageContent" class="control-label">Content</label>
                            <div class="controls">
                                <textarea id="txtPageContent" name="txtPageContent" ><?php echo set_value("txtPageContent");?></textarea>
