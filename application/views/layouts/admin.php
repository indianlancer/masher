...
<body>
    ...
    if(!isset($spans_arr))
        $spans_arr= array();
    ?>
        <?php echo $this->content->element('admin_navigation_part'); ?>
        <div class="container-fluid">
            <div class="row-fluid">
                <?php echo $this->content->element('admin_main_left',array('spans_arr' => $spans_arr)); ?>
                <?php echo $this->content->fetch('content'); ?>
                <?php echo $this->content->element('admin_main_right',array('spans_arr' => $spans_arr)); ?>
            </div>
        </div>
