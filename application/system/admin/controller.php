...
class _CONTROLLER_ extends RT_Controller {
	...
	public function index($startpoint=0,$orderby='id',$sort_order=false,$per_page = PER_PAGE) 
	{
            _THIS_LAYOUT_;
            $data['error']="";
            $data['sucessmessage']="";
            ...
            defpagination($total_rows,$per_page,10,4,_PAGINATION_PATH_); 
            ...
            $data['title_for_layout'] = _TITLE_DISPLAY_;
